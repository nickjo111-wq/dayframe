// DayFrame sync using @netlify/blobs (official package - auto-configures in Netlify functions)
...
exports.handler = async (event) => {
  ...
  if (event.httpMethod !== 'POaST') return { statusCode: 405, headers: cors, body: '{}' };
